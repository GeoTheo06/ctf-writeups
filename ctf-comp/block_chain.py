...
for i in range(0, len(ciphertext), 16):
    ...
    key_block = key_hash[:len(block)]
    plaintext_block = xor_bytes(block, key_block)
    plaintext_padded += plaintext_block

# Unpad
try:
    modified_plaintext = unpad(plaintext_padded)
except:
    print("Invalid padding.")
    exit()

# Assuming you know where the token is inserted
# For demonstration, let's print the decrypted plaintext
print("Decrypted Plaintext:", modified_plaintext.decode('utf-8', errors='ignore'))